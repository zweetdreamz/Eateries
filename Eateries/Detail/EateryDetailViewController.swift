...
class EateryDetailViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //tableView.backgroundColor = #colorLiteral(red: 0.9136232138, green: 0.9837724566, blue: 0.8788095117, alpha: 1) задний фон таблицы
        tableView.separatorColor = #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1) // разделитель таблицы
        tableView.tableFooterView = UIView(frame: CGRect.zero)// очистка пространства под таблицей
