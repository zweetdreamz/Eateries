...
class EateriesTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    //        Restaurant(name: "Ogonёk Grill&Bar", type: "ресторан", location: "Москва, Никольская улица 16 строение 1, вход со двора", image: "ogonek.jpg", isVisited: false),
    //        Restaurant(name: "Pivbar", type: "ресторан", location: "Москва, метро Маяковская", image: "elu.jpg", isVisited: false),
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let wasIntoWatched = userDefaults.bool(forKey: "wasIntoWatched")
        guard !wasIntoWatched else { return }
